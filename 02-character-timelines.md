# Character Timelines, Night of the Murder

All times approximate. Adjust to your table's surgery slot.

---

## STORM & AUTHORITY TIMELINE
...
| T−2h | **Swastika Sachs** | VIP wing / elevator | Threatens **CD Vance**, help trace Alex's wife or "elevator shaft" | Vance begins clinic/hospital search logs (E2-F) |
| T−2h | **CD Vance** | Server room | Forced wife hunt queries for Sachs | Reconstruction flags; admin tier anomalies |
| T−2h | **Alfie Austin** | Loading dock → VIP | Enters disguised as delivery driver | **Melody** saw him slip in |
| T−90m | **Officer Ray** | Security office | Debt pressure from Alex; reviews keycard logs | Knows log page later torn |
...
| T−45m | **Dr. Homes** | Pre op / consult | Alex intake; tension with Pepper | Prologue scene |
| T−30m | **Nurse Pepper** | VIP consult suite | Prep; secret eye on Alex | Pepper, Homes, Alex |
| T−15m | **Dr. Jetski** | OR prep | Loads tray from pharmacy, **tampered vial** | Unaware |
| T−10m | **Alex Austin** | Gowned, VIP route | **Real** arterial case; power play on Lacey's hospital; hunting ex wife | Multiple enemies in building |

---

## THE SURGERY (T = 0)

| Time | Character | Location | Activity | Status |
|------|-----------|----------|----------|--------|
| T+0 | **Dr. Homes** | OR table | Mid operation; arterial repair | Conscious |
...
| T+0 | **Alex Austin** | OR table | Patient | Sedated → **killed during blackout** |
| T+0 to T+15s | **Dr. Curie** | Eastern corridor → OR | Enters on keycard; night vision kill | **Immune / prepared** |
| T+0 to T+60s | **Lacey Lovely** | Admin terminal (2 floors up) | Manual grid override | Remote |
| T+15s | **Dr. Curie** | OR | Carotid incision; plants tool near Homes | Exits blind spot |
...
- **Alex:** Dead, expert carotid cut  
- **Curie:** Claims eastern corridor (false alibi for kill window)  
- **Lacey:** Admin wing, alibi as "director responding to crisis"  

---

## IMMEDIATE AFTERMATH (T + 5m to T + 45m)

| Time | Character | Location | Activity |
|------|-----------|----------|----------|
| T+2m | **Staff / Melody** | OR corridor | Run to fetch **Lacey** (admin) and **Ray** (security) |
| T+5m | **Nurse Pepper** | OR | Wakes terrified; sees Alex; shaking testimony, does not immediately accuse Homes |
...
| T+35m | **Dr. Curie** | Lounge → wing | Splits room for evidence search; steers blame toward Homes |
...
| Ep 2 | **Ray + Diamond + Curie** | Ray opens Lacey background; Diamond may volunteer wild theory; Curie: unlikely cutter, still a lead |
...
| Time | Character | Event |
|------|-----------|-------|
| Ep 3 | **Melody** | Finds keycard evidence; cornered in pharmacy wing |
| Ep 3 | **Dr. Curie** | **Attacks Melody** (KCl syringe) when Ray pursues shadow |
| Ep 3 | **Alfie** | Hunting knife drops in panic |
| Ep 3 | **Sachs** | Wire cutters discovered |
| Ep 3 | Players | Antidote puzzle, Calcium Gluconate |

**If antidote succeeds:** Melody whispers *"Admin computer… and Curie…"*  
...
| Ep 4 | **Lacey** | Admits running; **denies murder**, only wanted distance, not hate enough to kill |
| Ep 4 | **Curie** | Supports Ray's Lacey investigation; opinion: unlikely cutter, still a lead |
...
| Ep 4 | **Curie + Lacey** | Keycard bypass during exact 60s blackout |
| Ep 4 | **Room** | Dual ballot, target + moral verdict |

---

## CCTV / WITNESS GAPS (investigation friction)
...
| Pharmacy vault | Log only (code = Lacey) | Points to admin; Curie physically swapped vial |
| Power console | Manual override logged | Lacey or IT level access |
