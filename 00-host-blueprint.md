# Host Blueprint, Facilitator Knowledge Only
...
**Alfie Austin** (Alex's brother) is the player who **must reveal Genevieve's identity and the abuse** in Episode 4. Full backstory: [11-genevieve-backstory.md](11-genevieve-backstory.md)

**CD Vance** works for **Sachs under threat**, tracing Alex's wife through hospital/clinic systems for the stolen fortune. **Alex is revealed across four episodes as a bigger monster than his murderers:** [12-alex-revelation-arc.md](12-alex-revelation-arc.md)
...
## THE OPERATIONALLY TIGHT MURDER PLAN

| Step | Operation | Who | How |
|------|-----------|-----|-----|
| 1 | Drug Tampering | Dr. Curie | Swapped anesthesia vial in secure pharmacy vault using Lacey's high clearance access code |
| 2 | Sedative Delivery | Dr. Jetski (unknowing) | Injected tampered vial → backflow paralysis of Jetski + Nurse Pepper |
| 3 | Blackout Trigger | Lacey Lovely | Remote generator override from admin terminal, 60 sec total darkness |
| 4 | OR Entry | Dr. Curie | Stolen master keycard; blind spot of secure corridor |
| 5 | Execution | Dr. Curie | Night vision gear; single flawless carotid incision on Alex |
| 6 | Frame Up | Dr. Curie | Bloody surgical tool placed next to disoriented Dr. Homes |
| 7 | Cover Up | Lacey Lovely | Wipe server logs + adjust timestamps via CD Vance (botched) |

### Spatial configuration at blackout
**Inside OR:** Dr. Homes, Nurse Pepper, Dr. Jetski, Alex Austin  
**Outside/remote:** Dr. Curie (corridor entry), Lacey Lovely (admin office, 2 floors up)  
**Scattered:** All other players across VIP wing

---

## 4-EPISODE NARRATIVE TIMELINE

| Episode | Title | Runtime | Core focus |
|---------|-------|---------|------------|
| 1 | THE INCIDENT | 45 min | Shock, finger pointing, Homes framed |
| 2 | THE SYSTEM CRACKS | 60 min | Technical evidence; multi person coordination |
| 3 | THE HUMAN COST | 60 min | Melody attacked; street motives surface |
...
- **Ep 2:** Toxicology → Vance confesses Sachs wife hunt → Orphanage photo → Terminal override → Alex's scale surfaces  
...
**Targets:** Single suspect OR Pair (Curie + Lacey Lovely)

**Moral verdict:**
- **MURDER**, criminal act; maximum punishment  
- **JUSTICE**, justified execution; cover it up  
- **SYSTEM FAILURE**, burn logs; expose hospital  

### Ending A, Truth exposed (Curie + Lacey pair, or Curie/Lacey alone)
Room accuses correctly before sirens. Ray presents evidence to arriving watch. Full scripts: [05-episode-scripts.md](05-episode-scripts.md) → **AFTER THE BALLOT**.

### Ending B, Wrong target (Homes, Alfie, Sachs, others)
Room accuses wrong person. Watch arrests the innocent in the chaos. Curie + Lacey watch from the wing as patrol takes the fall guy.

### Ending C, System collapse (Ray accused / split vote / chaos)
Server room catastrophe. Vance + Homes killed. Watch arrives into rubble; Curie + Lacey slip through recovery chaos.

### Moral verdict (layer on any accusation)
**MURDER** / **JUSTICE** / **SYSTEM FAILURE**, read after accusation branch. Same file.

### All endings, Ep 4 coda (mandatory)
Ballot tally → accusation readout → moral coda → **POLICE ARRIVAL** → optional truth reveal → facilitator monologue. See [05-episode-scripts.md](05-episode-scripts.md).

### Jetski beat (early)
*"Killer in this lounge"* delivered in [10-the-gathering.md](10-the-gathering.md) after containment briefing, before wing search. Callback in facilitator truth reveal if room got it wrong.

---

## HOST PRINT PACKET CHECKLIST

- [ ] 11 player dossiers ([player-dossiers/](player-dossiers/)), fold **NIGHT TRUTH** on Curie & Lacey  
...
- [ ] 11 hospital ID badges  
- [ ] VIP Wing Logbook (Pepper)  
- [ ] Tampered anesthesia vial prop (Curie planted)  
- [ ] Private Investigator dossier (Alex's coat)  
- [ ] Newspaper clippings (E4-F Genevieve missing; E4-H sanctuary fire; see 15-evidence-materials.md)  
- [ ] Industrial wire cutters (Sachs)  
- [ ] Concealed hunting knife (Alfie)  
