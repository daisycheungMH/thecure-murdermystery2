...
# Storm & Containment Logic, Why This Investigation Works In World

**Purpose:** Answer the table's unspoken questions, *Where are the cops? Why are suspects investigating? Why listen to Ray?*
...
## Why no police on site (Episodes 1–3)

1. **Dispatch priority**, Municipal Watch logged the VIP wing death as **LC-4471**, but the storm placed it behind structural collapses, grid fires, and transit rescues across the city.
...
## Why suspects "solve it themselves"

Ray does not run a cozy mystery party. He runs **Containment Protocol Delta**, a hospital lockdown procedure written for biotech leaks and donor scandals, repurposed tonight.
...
### What Ray tells the room (Ep 1 handoff)

> "Municipal watch is not walking through that flood before morning. Until they do, this wing is sealed. You don't get to go home and invent an alibi in the rain. You stay. You talk. You find me something I can hand the real cops when they show, or I lock you in separate rooms and let them sort it. Your choice."
...
## Ray as investigator AND suspect
...
## Episode by episode authority map
...
## Player facing FAQ (put on table card if needed)
