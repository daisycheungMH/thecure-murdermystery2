# Officer Diamond, Beat Guide (Host + Player)

**Player dossier:** [player-dossiers/11-officer-diamond.md](player-dossiers/11-officer-diamond.md)  
**Persona:** [14-actor-personas.md](14-actor-personas.md) → Officer Diamond

Diamond is a **full player** with dossier and pack access. She supports perimeter and escort while staying in play for the whole night.
...
| Do | Don't |
|----|-------|
| Gamify corridor patrol, door checks, phases | Steal Ray or Marz's authority |
...
1. **End of Act 1** (after The Gathering): Ray radios overflow; Diamond arrives at the lounge door. See [player-performance-script.md](player-performance-script.md).
2. **Act 2 evidence search:** Escort pairs; assign "Phase Three: Controlled Chaos."
3. **Between acts:** Radio check with Marz; credibility points joke; exit.
