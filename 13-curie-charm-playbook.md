...
6. **Genuine niceness**: not performed innocence; optimism in a corpse wing reads wrong on accident  
7. **OR keycard in the log** names Curie's badge; he has too many corridor friends to say who lifted it. Truth lands when evidence surfaces (torn page, mainframe, Melody), not when Curie turns paranoid
...
## Pepper's throat clear (host cue)

Use **three times max** per game so it stays funny:
...
> **CURIE:** *(sincere, not performing)* Because sometimes we're wrong, Doctor. That's why we investigate.  
> **RAY:** *(almost amused)* Keep talking, Homes.

---

## Absolution arc (facilitator)

High-suspicion characters should feel **less likely over four episodes**, not cleared in Act 1. Drop absolution **subtly** through card footnotes and testimony; do not lecture the room.
...
| **Ep 2** | **Lacey, Curie** (mechanism) | E2-B/E2-C admin tier access, not OR console |
| **Ep 3** | **Alfie, Sachs** | E3-C/E3-D wrong weapons; E3-A supports badge theft |
| **Ep 4** | **Curie, Homes, Lacey** | E4-C card vs corridor; E4-E wound profile; E4-B motive not mechanism |
