# Evidence Materials, Player Readable

**For players.** Print each evidence card when it enters play (see [04-evidence-index.md](04-evidence-index.md) for when to drop).  
Each entry: short description + full text to read aloud or hand out.
...
**Description:** OR floor diagram showing two distinct blood behaviors near the operating table. Suggests bleeding started before the blackout and was interrupted when the lights cut.
...
**Description:** Empty anesthesia vial found in OR waste. Seal broken and re-set; pharmacy sticker does not match batch records.
...
> Client: A.A. (financier, Indigo District)  
...
**Description:** Not a printed card. Scene fact read by the host when players examine the OR after the blackout.
...
### E2-D, Orphanage photo

**Description:** Faded print from an old staff locker. Two children at a regional youth sanctuary. Connects to P.I. dossier "childhood contact" after Alfie's reveal.

**Text:**

> **PHOTO, REVERSE INSCRIPTION (faded):**  
> *"G. + C., sanctuary summer, before anyone promised us safety."*  
> Two children, arms linked, squinting at camera. Girl: guarded smile. Boy: already standing like he's protecting someone.  
> *(No adult names. No hospital badge. Easy to miss if players don't look in lockers.)*
...
**Description:** Terminal export showing coerced database sweeps. Sachs ordered a hunt for the client's vanished wife; trails point at hospital admin tier.
...
**Description:** If antidote puzzle succeeds, Melody survives long enough to name admin and Curie. Host reads; not a physical card unless printed.

**Text:**

> **MELODY, POST ANTIDOTE (weak):**  
> *"It's not just him… it's everything… all of you… admin computer… and Curie…"*  
> *(She loses consciousness again before details. Enough to send Ray upstairs.)*
...
> **FAIL:** Melody unavailable for direct testimony; E3-A must come through trade with another player

---

## EPISODE 4

### E4-A, Two synchronized footsteps

**Description:** Alfie testimony heard during final interviews. Suggests a pair moved in the OR corridor during the blackout window.

**Text:**

> **WITNESS NOTE, ALFIE AUSTIN**  
> *"I was on the loading route. I heard footsteps in the secure corridor, two people, matched pace, like they rehearsed it. Not running. Not storming. Just… efficient. I thought it was staff. Now I don't know."*
...
**Description:** Proof of cover up. Someone ordered Vance to scrub the blackout window after the murder.
...
### E4-F, Newspaper clipping, Genevieve missing

**Description:** Archived sidebar about a vanished wife. Name redacted as G.A. Players link to Genevieve only **after** Alfie's reveal.

**Text:**

> **LESBIAN CITY HERALD**, archived sidebar, name redacted per victim shield order  
>
> *"…identified only as G.A., hospitalized twice in one year for 'fall related' injuries while cohabiting with a financier later linked to predatory lending in the Indigo District. Neighbors reported shouting. One prior domestic call withdrawn before officers arrived. Subject vanished in [YEAR]. Financier told police she was 'unstable' and had stolen from family business. Recovery efforts ongoing. No body recovered."*
...
>
> A.A., collections, VIP medical cover  
...
> **LESBIAN CITY HERALD**, metro section, [YEAR]  
>
> *"Three dead after overnight fire at regional youth sanctuary residence in the outer district. Investigators cited faulty wiring, though neighbors reported a luxury sedan leaving the scene before engines arrived. A financier known for aggressive recovery work in the Indigo District was questioned and released; sources described the blaze as 'consistent with warnings issued to debtors who involve family members.' No charges filed. A spokesperson for the recovery firm called it 'a tragic coincidence unrelated to ongoing collection matters.'"*  
>
> *(Players who connect G.A., the ledger's 'sanctuary contact,' and tonight's VIP patient should recognize the same operator.)*

---

## PROPS LIST (physical items)

**Print / craft checklist for host. Pair with evidence cards above where noted.**

| Prop | Qty | Used by | When | Notes |
|------|-----|---------|------|-------|
...
| Pharmacy vault log printout | 1 | Host | Ep 2 | **E2-B** |
| Power override log printout | 1 | Host | Ep 2 | **E2-C** |
| Orphanage photo | 1 | Locker hide | Ep 2 | **E2-D** |
| Vance search log printout | 1 | Vance / host | Ep 2 | **E2-F** |
| Torn keycard log page | 1 | Melody | Ep 3 | **E3-A** |
| KCl syringe (prop) | 1 | Pharmacy hall | Ep 3 | **E3-B** |
| Hunting knife (prop) | 1 | Alfie | Ep 3 | **E3-C** |
| Wire cutters (prop) | 1 | Sachs | Ep 3 | **E3-D** |
